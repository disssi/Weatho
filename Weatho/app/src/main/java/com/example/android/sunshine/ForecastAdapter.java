...
import com.example.android.weatho.utilities.WeathoDateUtils;
import com.example.android.weatho.utilities.WeathoWeatherUtils;
...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        switch (viewType) {
            ...
            case VIEW_TYPE_TODAY:
                weatherImageId = WeathoWeatherUtils
        ...
        String dateString = WeathoDateUtils.getFriendlyDateString(mContext, dateInMillis, false);
         ...
         * Weather Description *
         ***********************/
        String description = WeathoWeatherUtils.getStringForWeatherCondition(mContext, weatherId);
        ...
        double highInCelsius = mCursor.getDouble(MainActivity.INDEX_WEATHER_MAX_TEMP);
          ...
          * String.
          */
        String highString = WeathoWeatherUtils.formatTemperature(mContext, highInCelsius);
         /* Create the accessibility (a11y) String from the weather description */
        ...
        double lowInCelsius = mCursor.getDouble(MainActivity.INDEX_WEATHER_MIN_TEMP);
          ...
          * String.
          */
        String lowString = WeathoWeatherUtils.formatTemperature(mContext, lowInCelsius);
